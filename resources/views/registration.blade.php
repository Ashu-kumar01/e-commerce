            ...
            <form action="{{ route('account.register') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="fullName" id="fullName" placeholder="Jane Doe"
                        value="{{ old('fullName') }}"
                        class="@error('fullName') is-invaild @enderror w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-all duration-300">
                    @error('fullName')
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" placeholder="jane@example.com"
                        value="{{ old('email') }}"
                        class="@error('email') is-invaild @enderror w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-all duration-300">
                    @error('email')
                        <p class="text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="password" name="password" id="password" value="{{ old('password') }}"
                            placeholder="••••••••"
                            class="@error('password') is-invaild @enderror w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-all duration-300">
                        @error('password')
                            <p class="text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
