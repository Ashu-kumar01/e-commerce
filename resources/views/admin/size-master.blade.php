        ...
        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-7">
            <div>
                ...
                <div class="flex items-center gap-1.5 mb-2.5">
                    ...
                    <span class="text-[11px] text-violet-400 font-medium">Category Size Master</span>
                </div>
                <h1 class="font-display text-2xl md:text-[28px] font-bold grad-text leading-tight">Category Size Master</h1>
                    ...
                    <div class="flex items-center gap-3">
                        <div class="mod-icon"
                            ...
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" class="text-violet-400">
                                <path d="M4 6h16M4 10h16M4 14h8" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" />
                            </svg>
                        </div>
                        <div>
                            <div class="sec-title">Category Size Master</div>
                        </div>
                    </div>
                    ...
                    <div class="card-form">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                            <div>
                                ...
                                <select class="sel" name="category_id" id="category_id">
                ...
                <div>
                    ...
                    <div class="card-table">
                        <table class="tbl">
                            <thead>
                                <tr>
                                    <th class="sort-th">Category Name <svg width="8" height="8"
                                            viewBox="0 0 24 24" fill="none" class="inline ml-1 text-gray-700">
                                            <path d="M8 9l4-4 4 4M16 15l-4 4-4-4" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" />
                                        </svg></th>
                                    <th class="hide-xs">Size</th>
                                    <th>Status</th>
                                    <th>Actions</th>
                                </tr>
                            </thead>
                            <tbody id="catTableBody">
                                @foreach ($sizes as $size)
                                    <tr>
                                        <td class="font-medium text-gray-200"> {{ $size->category->name ?? 'N/A' }}</td>
                                        <td class="font-mono text-[11px] text-violet-400/70 hide-xs">
                                            {{ $size->size }}
                                        </td>
                                        <td>
                                            <span class="badge  {{ $size->status ? 'badge-on' : 'badge-off' }}">
